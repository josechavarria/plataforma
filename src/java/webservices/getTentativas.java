 ...
 */
@WebServlet(name = "getTentativas", urlPatterns = {"/getTentativas"})
public class getTentativas extends HttpServlet {
    ...
    protected  void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       if(se==null){
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print(se.getCaderno().getPerguntaAtual().getTentativas());
